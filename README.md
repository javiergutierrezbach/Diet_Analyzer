...
- A README.md detailing all the steps to reproduce your results. I will use the readme to attempt to reproduce your results.
- No references to local file structure. All references should be from the main directory of the repo using relative pathnames.
